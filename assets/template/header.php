...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand w-25" href="#"><img src="../img/logo-laplateforme-2024.png" alt="logo la plateforme" class="img-fluid"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="../views/connexion_page.php">Connexion</a>
        </li>
        <li class="nav-item">
